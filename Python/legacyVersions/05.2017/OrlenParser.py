...
def parse(etreeElement):
	...
	tableDate = etreeElement.xpath("//span[@id='ctl00_ctl00_SPWebPartManager1_g_73ff41bc_f8a0_4b3a_98ea_c4200b64ef40_ctl00_lblDate']")
	...
	tableLight = etreeElement.xpath("//table[@class='tableLight']")
